...
int main(int argc, char **argv){
    ...
    Window3D *view = new Window3D;
    view->defaultFrameGraph()->setClearColor(QColor(QRgb(0x4d4d4f)));
    View3DWindow *container = (View3DWindow *) QWidget::createWindowContainer(view);
//    View3DWindow *container_view = (View3DWindow *) &container;
    QSize screenSize = view->screen()->size();
    container->setMinimumSize(QSize(200, 100));
    container->setMaximumSize(screenSize);
//    container_view->setMinimumSize(QSize(200,100));
    ...
    TextEdit *moveMouse = new TextEdit(widget);
...
//    QSignalMapper *mapper = new QSignalMapper(moveMouse);

//    mapper->setMapping(widget, QString::number(widget->x_move));
//    QObject::connect(mapper, SIGNAL(mapped(QString)), moveMouse, SLOT(setText(QString)));
